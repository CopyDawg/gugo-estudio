    ...
    <div className="wrapper">
      ...
      <section className="about-section">
        ...
        <header className="about-header">
          <img src="src\assets\backgrounds\about-header.png"/>
        ...
        <main className="about-main">
          ...
          <div className="about-container">
              ...
              <img src="src\assets\about_me_image.png" />
          </div>
...
opciones diversas y emocionantes.</p>
              ...
              <img src="src\assets\about-tattoo.png" className="tattoo-border"/>
          </div>
...
y mejorar mis habilidades como artista.</p>
              ...
              <img src="src\assets\about_painting.png" className="painting-border" />
          </div>
        </main>
